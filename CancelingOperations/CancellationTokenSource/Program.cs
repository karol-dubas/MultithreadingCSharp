...
// CancellationTokenSource is created at the source of an operation/s that may need to be cancelled.
cts.Cancel();
...
// CancellationToken doesn't have the capability to trigger cancellation, it can be only observed,
...
// it just won't start Task.Run if CancellationToken is marked as cancelled, to skip scheduling process.
